...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView healthIssues = findViewById(R.id.cardHealthIssues);
        healthIssues.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity.this, HealthIssuesActivity.class));
            }
        });
