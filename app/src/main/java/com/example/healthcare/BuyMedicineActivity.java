...
public class BuyMedicineActivity extends AppCompatActivity {
    ...
    private String[] package_details = {
                    ...
                    "Dole 650 Tablet helps relieve pain and fever by blocking the release, of certain chemical messages responsible for fever and pain",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lst = findViewById(R.id.listViewBc);
        btnBack = findViewById(R.id.BMback);
        btnGoToCart = findViewById(R.id.BMCheckout);

        btnGoToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BuyMedicineActivity.this, BMCartActivity.class));
            }
        });
